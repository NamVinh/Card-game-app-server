...
public class Adapter_CardYugiohAll extends RecyclerView.Adapter<Adapter_CardYugiohAll.ViewHolder> {
    List<Card> cardyugiohList;
    Context context;
    String BaseURL = "http://192.168.1.7:4000/";


    public Adapter_CardYugiohAll(List<Card> cardyugiohList, Context context){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.cardview_tatca,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            super(itemView);
            img_card = itemView.findViewById(R.id.img_cardgrid);
            txt_tencard = itemView.findViewById(R.id.txttencardgrid);
            txt_giatien = itemView.findViewById(R.id.txt_giacardgrid);
            txt_tentheloai = itemView.findViewById(R.id.txttentheloaicardgrid);
